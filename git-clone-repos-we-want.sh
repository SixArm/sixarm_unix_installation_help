...
git clone https://github.com/SixArm/sixarm_mysql_scripts.git
git clone https://github.com/SixArm/sixarm_postgresql_scripts.git
git clone https://github.com/SixArm/sixarm_ruby_gem_scripts.git
